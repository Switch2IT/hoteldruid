...
if ($id_utente and $id_utente == 1 and (C_CREA_ANNO_NON_ATTUALE != "NO" or $anno == $anno_corrente)) {
...
} # fine if ($id_utente and $id_utente == 1 and (C_CREA_ANNO_NON_ATTUALE != "NO" or $anno == $anno_attuale))
