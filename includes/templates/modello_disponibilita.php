...
<input type=\"hidden\" name=\"id_periodi_costo$numca" . "_$n_t\" value=\"" . ${"id_periodi_costo" . $numca . "_" . $n_t} . "\">";
    ...
    for ($n_t = 1; $n_t <= $num_tipologie; $n_t++) {
        ...
        if ($num_idinizioperiodo == 0) {
            ...
            $idinizioperiodo[$n_t] = risul_query($idinizioperiodo[$n_t], 0, 'idperiodi');
        }
        ...
        if ($num_idfineperiodo == 0) {
            ...
            $idfineperiodo[$n_t] = risul_query($idfineperiodo[$n_t], 0, 'idperiodi');
        }
                ...
                for ($num1 = $idinizioperiodo[$n_t]; $num1 <= $idfineperiodo[$n_t]; $num1++) {
                    ...
                    if (!strcmp($costo_tariffa_settimana, "") and !strcmp($costo_tariffap_settimana, "")) {
                        ...
                        if ($dati_r2['napp'][$tipotariffa] > 1) {
                            $costo_tariffap_settimana_alt = (double)$costo_tariffap_settimana * (double)($numpersone - 1);
                                ...
                                if ($associa_costo == "SI") {
                                    ...
                                    if ($periodo_costo_trovato == "NO") $associa_costo = "NO";
                                        ...
                                        if (controlla_num_limite_costo($tablecostiprenota, $tableprenota, $dati_ca, $num_costo, $num_costi_presenti_copia, $idinizioperiodo[$n_t], $idfineperiodo[$n_t], $settimane_costo2, $moltiplica_costo2[0]) == "NO") $associa_costo = "NO";
                                            ...
                                            if (controlla_num_limite_costo($tablecostiprenota, $tableprenota, $dati_ca, $num_costo, $num_costi_presenti_copia, $idinizioperiodo[$n_t], $idfineperiodo[$n_t], $settimane_costo2, $moltiplica_costo2[$num1]) == "NO") {
                                                $num_app_reali_costo2 = $num1;
                                                break;
                                            }
                                        } # fine for $num1
...
#$prezzi_costi_agg[$num_costi_agg] = $prezzo_costo[$numca][1];
            ...
            if ($continuare_totale == "SI") {
                ...
                if ($mostra_richiesta_via_mail == "SI" and $manda_mail == "SI") {
                    ...
                    if (($chiedi_telefono == "SI" and (strlen($telefono) - strlen(preg_replace("/[0-9]/", "", $telefono))) < 5) or strlen($telefono) > 50) {
                        $inviare = "NO";
                        $telefono_sb = "SI";
                    }
                    if ($chiedi_telefono2 == "NO") $telefono2 = "";
                    if (($chiedi_telefono2 == "SI" and (strlen($telefono2) - strlen(preg_replace("/[0-9]/", "", $telefono2))) < 5) or strlen($telefono2) > 50) {
                        $inviare = "NO";
                        $telefono2_sb = "SI";
                    }
                    if ($chiedi_telefono3 == "NO") $telefono3 = "";
                    if (($chiedi_telefono3 == "SI" and (strlen($telefono3) - strlen(preg_replace("/[0-9]/", "", $telefono3))) < 5) or strlen($telefono3) > 50) {
                        $inviare = "NO";
                        $telefono3_sb = "SI";
                    }
                    if ($chiedi_fax == "NO") $fax = "";
                    if (($chiedi_fax == "SI" and (strlen($fax) - strlen(preg_replace("/[0-9]/", "", $fax))) < 5) or strlen($fax) > 50) {
                        $inviare = "NO";
                        $fax_sb = "SI";
                    }
                    if ($chiedi_codfiscale == "NO") $codfiscale = "";
                    if (($chiedi_codfiscale == "SI" and strlen($codfiscale) < 5) or strlen($codfiscale) > 50) {
                        $inviare = "NO";
                        $codfiscale_sb = "SI";
                    }
                    if ($chiedi_partitaiva == "NO") $partitaiva = "";
                    if (($chiedi_partitaiva == "SI" and strlen($partitaiva) < 5) or strlen($partitaiva) > 50) {
                        $inviare = "NO";
                        $partitaiva_sb = "SI";
                    }
...
this case you can ignore this message.";
                        ...
                        if ($utente_messaggio) {
                            ...
                            if ($utente_trovato == "SI") {
                                ...
                                $campi_pers_clienti = "";
                                while (list($campo_pc, $val_pc) = each($campi_pers_clienti_vett)) $campi_pers_clienti .= ">$campo_pc<$val_pc";
...
$dati_form_iniziale";
                        ...
                        if ($chiedi_cognome != "NO") {
                            if ($cognome_richiedente_sb == "SI") {
                                $apertura_tag_f = $apertura_tag_font_rosse;
                                $chiusura_tag_f = $chiusura_tag_font_rosse;
                                $asterisco = $fr_asterisco_rosso;
                            } else {
                                $apertura_tag_f = $apertura_tag_font;
                                $chiusura_tag_f = $chiusura_tag_font;
                                $asterisco = $fr_asterisco_nero;
                            }
