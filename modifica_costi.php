    ...
    if ($anno_utente_attivato == "SI" and $priv_mod_costo_agg != "n") {
        ...
        if ($num_costo != "") {
            ...
            if ($modifica_costo) {
                ...
                if ($valore_p_ca and $tipo_ca == "s" and substr($tipo_percentuale, 0, 7) != "tariffa") {
                    $errore = "SI";
                    $conflitti .= "2-3;";
                }
                ...
                if ($valore_p_ca and $associasett == "n") {
                    $errore = "SI";
                    $conflitti .= "3-10;";
                }
                ...
                if ($tipo_ca == "s") {
                    ...
                    if ($associa_tariffe != "n" and $numsett_ca == "c") {
                        $errore = "SI";
                        $conflitti .= "5-9;";
                    }
                    if ($assegna_da_giorno_ini and $numsett_ca == "c") {
                        $errore = "SI";
                        $conflitti .= "6-9;";
                    }
                    if ($assegna_prenota_contemp and $numsett_ca == "c") {
                        $errore = "SI";
                        $conflitti .= "7-9;";
                    }
                    if ($associasett != "s" and ($numsett_ca == "s" or $numsett_ca == "n" or $numsett_ca == "g")) {
                        $errore = "SI";
                        $conflitti .= "9-10;";
                    }
                    if ($numsett_ca == "s") {
                ...
                if ($beni_inv_elimina == "sel") {
                    if (controlla_num_pos($num_beni_inv_elimina_sel) == "NO" or $num_beni_inv_elimina_sel == 0) $errore = "SI";
                        ...
                        if ($tipo_bie == "a") {
                            ...
                            if ($moltiplica_ca == "t" or $tipo_moltmax == "t") {
                                $errore = "SI";
                                $conflitti .= "11-12;";
                            }
                        } # fine if ($tipo_bie == "a")
                ...
                if ($periodi_permessi == "sel") {
                    if (controlla_num_pos($num_periodi_permessi_sel) == "NO" or $num_periodi_permessi_sel == 0) $errore = "SI";
                        ...
                        for ($num1 = 1; $num1 <= $num_periodi_permessi_sel; $num1++) {
                            if (str_replace("\\\"" . ${"pp_dal" . $num1} . "\\\">", "", $file_date_int) == $file_date_int) {
                                $errore = "SI";
                                $conflitti .= "13;";
                            }
                            if (str_replace("\\\"" . ${"pp_al" . $num1} . "\\\">", "", $file_date_int) == $file_date_int) {
                                $errore = "SI";
                                $conflitti .= "13;";
                            }
                            $nuova_ultima_data = str_replace("-", "", ${"pp_dal" . $num1});
                            if ($nuova_ultima_data <= $ultima_data) {
                                $errore = "SI";
                                $conflitti .= "13;";
                ...
                if ($combina_ca == "s") {
                    ...
                    if ($beni_inv_elimina != "nessuno" and $tipo_bie == "a") {
                        $errore = "SI";
                        $conflitti .= "12-16;";
                    }
                    if ($app_incompatibili == "SI") {
                ...
                if ($letto_ca != "n") {
                    if ($valore_p_ca and substr($tipo_percentuale, 0, 7) != "tariffa") {
                        $errore = "SI";
                        $conflitti .= "3-17;";
                    }
                    if ($moltiplica_ca == "p" or $moltiplica_ca == "t" or $tipo_moltmax == "p" or $tipo_moltmax == "t") {
                        $errore = "SI";
                        $conflitti .= "11-17;";
                    }
                } # fine if ($letto_ca != "n")
                ...
                if ($limite_ca != "n") {
                    if ($tipo_ca == "s" and $associasett != "s" and $numsett_ca != "t") {
                        $errore = "SI";
                        $conflitti .= "9,10-19;";
                    }
                    if ($tipo_ca == "s" and $associasett != "s" and $periodi_permessi != "tutti" and $tipo_pp == "p") {
                        $errore = "SI";
                        $conflitti .= "9,13-19;";
                    }
...
";
                ...
                for ($numtariffa = 1; $numtariffa <= $numero_tariffe; $numtariffa++) if ($dati_ca[$num_costo]["tipo_associa_tariffa" . $numtariffa]) $default_tipo_associa = $dati_ca[$num_costo]["tipo_associa_tariffa" . $numtariffa];
                for ($numtariffa = 1; $numtariffa <= $numero_tariffe; $numtariffa++) {
                    if ($attiva_tariffe_consentite == "n" or $tariffe_consentite_vett[$numtariffa] == "SI") {
                        $tariffa = "tariffa" . $numtariffa;
                        ...
                        if ($dati_ca[$num_costo]["tipo_associa_tariffa" . $numtariffa]) {
                            $checked = " checked";
                            $b = "<b>";
                            $b_slash = "</b>";
                        } else {
...
<input type=\"checkbox\" name=\"sel$tariffa\" value=\"s\"$checked>$b" . "$nometariffa_vedi$b_slash</label></td>";
                        ...
                        if (substr($dati_ca[$num_costo]["tariffa" . $numtariffa], 0, 1) == ">") $selected = " selected";
                        else $selected = "";
...
";
                        if (substr($dati_ca[$num_costo]["tariffa" . $numtariffa], 0, 1) == "|") echo "sel_corr.selectedIndex = 4;
agg_sel_giorni_associa_tariffa('$tariffa','$valminmax2');
";
                        echo "-->
</script>
</td>";
                        if ($dati_ca[$num_costo]["tipo_associa_tariffa" . $numtariffa] == "p") {
                            $checked = " checked";
                            $b2 = $b;
                            $b_slash2 = $b_slash;
                        } else {
                        ...
                        if ($dati_ca[$num_costo]["tipo_associa_tariffa" . $numtariffa] == "r") {
                            $checked = " checked";
                            $b2 = $b;
                            $b_slash2 = $b_slash;
                        } else {
                        ...
                        if ($dati_ca[$num_costo]["tipo_associa_tariffa" . $numtariffa] == "s") {
                            $checked = " checked";
                            $b2 = $b;
                            $b_slash2 = $b_slash;
                        } else {
...
<tr><td colspan=\"2\"><small>6. ";
                ...
                if (substr($dati_ca[$num_costo]['assegna_da_ini_prenota'], 0, 1) != ">") {
                    $sel_m = " selected";
                    $sel_p = "";
                } else {
                    $sel_m = "";
...
<table><tr><td>";
                    ...
                    for ($num1 = 0; $num1 < $num_appartamenti; $num1++) {
                        ...
                        if ($priv_vedi_tab_appartamenti == "s" or $appartamenti_consentiti[$idappartamenti] != "NO") {
                            if (str_replace(",$idappartamenti,", "", $app_incomp) != $app_incomp) {
                                $checked = " checked";
                                $b = "<b>";
                                $b_slash = "</b>";
                            } else {
...
<td style=\"width: 130px;\">";
                ...
                if (!$dati_ca[$num_costo]['numlimite']) {
                    $checked = " checked";
                    $b = "<b>";
                    $b_slash = "</b>";
                } else {
...
<table>";
                if ($dati_ca[$num_costo]['var_percentuale'] == "s") {
                    $checked = " checked";
                    $b = "<b>";
                    $b_slash = "</b>";
                } else {
...
$b" . mex("Numero per cui viene moltiplicato", $pag) . "$b_slash</label></td></tr>";
                if ($dati_ca[$num_costo]['var_beniinv'] == "s") {
                    $checked = " checked";
                    $b = "<b>";
                    $b_slash = "</b>";
                } else {
...
$b" . mex("Tariffe incompatibili", $pag) . "$b_slash</label></td></tr>";
                if ($dati_ca[$num_costo]['var_appi'] == "s") {
                    $checked = " checked";
                    $b = "<b>";
                    $b_slash = "</b>";
                } else {
