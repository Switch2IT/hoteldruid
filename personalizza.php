...
<td>" . mex("Query", $pag) . "</td></tr>";
                    if (@is_file($file_log)) {
                        ...
                        for ($num1 = 1; $num1 < $num_lin; $num1++) {
                            ...
                            $small = "";
                            $slash_small = "";
                            if (strlen($linea[2]) > 200) {
                                $small = "<small><small>";
                                $slash_small = "</small></small>";
                            } elseif (strlen($linea[2]) > 70) {
                                $small = "<small>";
                                $slash_small = "</small>";
                            }
...
<button class=\"webs\" type=\"submit\"><div>" . mex("Pagine per il sito web", $pag) . "</div></button>
                ...
                if ($priv_crea_interconnessioni == "s" and C_CREA_SUBORDINAZIONI != "NO") {
