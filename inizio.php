...
//esiste l'anno richiesto
            ...
            if (!$numconnessione and C_MOSTRA_COPYRIGHT != "NO") echo "<table style=\"background-color: #ffffff; width: 99%; height: 97%; margin-right: auto; margin-left: auto;\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr><td style=\"vertical-align: top;\">";
...
# Non esiste l'anno richiesto
            ...
            if (controlla_anno($anno) == "NO" or $id_utente != 1 or $installazione_subordinata == "SI" or (C_CREA_ANNO_NON_ATTUALE == "NO" and $anno != $anno_corrente)) echo mex("Il formato dell'anno richiesto è sbagliato", $pag) . ".<br>";
            else {
