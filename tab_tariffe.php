                ...
                for ($num1 = 1; $num1 <= $num_tariffe_mostra; $num1++) {
                    if ($attiva_tariffe_consentite == "n" or $tariffe_consentite_vett[${"numtariffa" . $num1}] == "SI") {
                        ...
                        if ($dati_r2['napp'][$tariffa[$num1]] > 1) {
                            $tar_corr = (string)((double)$tar_corr * (double)$dati_r2['napp'][$tariffa[$num1]]);
                        ...
                        if ($sett_in_per == 1 or (!strcmp($tar_corr, "") and !strcmp($tarp_corr, ""))) {
                            if ($sett_in_per == 1) $chiusa_colonna_periodo[$num1][0] = "";
                        ...
                        if ($dati_tariffe[$tariffa[$num1]]['chiusa'][risul_query($periodi, ($sett_in_per - 1), 'idperiodi')]) $chiusa_colonna_periodo[$num1][0] = 1;
                    ...
                    for ($num2 = 1; $num2 <= $num_tariffe_mostra; $num2++) {
                        if ($attiva_tariffe_consentite == "n" or $tariffe_consentite_vett[${"numtariffa" . $num2}] == "SI") {
                            ...
                            if ($dati_r2['napp'][$tariffa[$num2]] > 1) {
                                $tar_corr = (string)((double)$tar_corr * (double)$dati_r2['napp'][$tariffa[$num2]]);
                            ...
                            if ($sett_in_per == 1 or (!strcmp($tar_corr, "") and !strcmp($tarp_corr, ""))) {
                                ...
                                if ($sett_in_per == 1) ${$tariffa[$num2] . "c"} = "";
                            } # fine if ($sett_in_per == 1 or (!strcmp($tar_corr,"") and !strcmp($tarp_corr,"")))
                            ...
                            if ($dati_tariffe[$tariffa[$num2]]['chiusa'][risul_query($periodi, $num1, 'idperiodi')]) ${$tariffa[$num2] . "c"} = 1;
                        } # fine if ($attiva_tariffe_consentite == "n" or...
                    } # fine for $num2
                } # fine while ($sett_in_per == 0 or...
            ...
            for ($num1 = 1; $num1 <= $num_tariffe_mostra; $num1++) {
                if ($attiva_tariffe_consentite == "n" or $tariffe_consentite_vett[${"numtariffa" . $num1}] == "SI") {
                    ...
                    for ($num2 = 0; $num2 <= $num_colonne_periodi; $num2++) {
                        ...
                        echo "<td align=\"center\"$style>$tariffa_vedi</td>";
                    } # fine for $num2
                    echo "</tr>";
                } # fine if ($attiva_tariffe_consentite == "n" or...
            } # fine for $num1
