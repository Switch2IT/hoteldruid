...
<option value=\"\" selected>----</option>";
                ...
                do {
                    ...
                    echo "<option value=\"$data_select\">$data_select_vedi</option>";
...
<option value=\"\">----</option>";
            ...
            if ($priv_vedi_tab_costi == "p" or $priv_vedi_tab_costi == "g") {
                ...
                if ($priv_vedi_tab_costi == "g") {
                    reset($utenti_gruppi);
                    while (list($idut_gr, $val) = each($utenti_gruppi)) if ($idut_gr != $id_utente) $condizione_variazioni_proprie .= " or utente_inserimento = '$idut_gr'";
            ...
            echo "<table class=\"t1\" style=\"background-color: $colore; margin-left: auto; margin-right: auto;\" width=200 border=\"$t1border\" cellspacing=\"$t1cellspacing\" cellpadding=\"$t1cellpadding\">
