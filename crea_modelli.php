...
if ($priv_crea_interconnessioni == "s" and $anno_utente_attivato == "SI") {
    ...
    if ($eliminacampipers or $aggiungicampipers or $eliminacampicond or $aggiungicampicond) {
        unset($crea_modello);
        $$nome_form_modello_passa = "SI";
    ...
    if ($crea_modello) {
        ...
        if (C_BACKUP_E_MODELLI_CON_NUOVI_DATI == "NO") $fonte_dati_conn = "attuali";
...
# Prendo i dati dal file se già esistente
            ...
            if (@is_file("$percorso_cartella_modello/$nome_file") and C_RESTRIZIONI_DEMO_ADMIN != "SI") {
            ...
            } # fine if (@is_file("$percorso_cartella_modello/$nome_file") and C_RESTRIZIONI_DEMO_ADMIN != "SI")
...
<input type=\"text\" name=\"intervalloperiodo$num1\" value=\"" . ${"intervalloperiodo" . $num1} . "\" size=\"2\" maxlength=\"2\"><br>";
            ...
            if (!$estendi_ultima_data or strtoupper($estendi_ultima_data) == $SI or $estendi_ultima_data == "SI") {
                $sel_SI = " selected";
                $sel_NO = "";
            } else {
                $sel_NO = " selected";
...
<label><input type=\"radio\" name=\"m_stile_data\" value=\"usa\"$check_data_usa>08-27-2002</label>
            ...
            if (!$anteponi_nome_valuta or strtoupper($anteponi_nome_valuta) != $SI) {
                $sel_NO = " selected";
                $sel_SI = "";
            } else {
                $sel_SI = " selected";
...
<table style=\"margin-left: auto; margin-right: auto;\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\">";
 ...
 (" . mex("col nome", $pag) . " <input type=\"text\" name=\"$nome_tariffa_imposto\" value=\"$val\" size=\"22\">)</td>";
            ...
            if (!$chiedi_numero_appartamenti_per_tipologia or strtoupper($chiedi_numero_appartamenti_per_tipologia) == $SI) {
                $sel_SI = " selected";
                $sel_NO = "";
            } else {
                $sel_NO = " selected";
...
" . mex("Parola da utilizzare per indicare gli appartamenti", 'unit.php') . ":
 ...
 " . mex("singolare", $pag) . ": <input type=\"text\" name=\"parola_appartamento\" size=\"15\" value=\"$parola_appartamento\">
            ...
            if (!$aggiungi_altre_tipologie or strtoupper($aggiungi_altre_tipologie) == $SI) {
                $sel_SI = " selected";
                $sel_NO = "";
            } else {
                $sel_NO = " selected";
...
" . mex("Numero massimo di tipologie", $pag) . ":
 <input type=\"text\" name=\"max_num_tipologie\" size=\"3\" value=\"$val\">
            ...
            $sel_chied = "";
            $sel_poss = "";
            if (strtoupper($cerca_appartamenti_vicini) == $SI) {
                $sel_SI = " selected";
                $sel_NO = "";
            }
            if (strtoupper($cerca_appartamenti_vicini) == strtoupper(mex("se possibile", $pag))) {
                $sel_poss = " selected";
                $sel_NO = "";
            }
            if (strtoupper($cerca_appartamenti_vicini) == strtoupper(mex("chiedere", $pag))) {
                $sel_chied = " selected";
                $sel_NO = "";
            }
...
<option value=\"chiedere\"$sel_chied>" . mex("chiedere", $pag) . "</option>
            ...
            if (!$chiedi_numero_persone or strtoupper($chiedi_numero_persone) == $NO) {
                $check_NO = " checked";
                $check_SI = "";
            } else {
                $check_SI = " checked";
...
<table><tr><td style=\"width: 25px;\"></td><td>" . mex("Se il costo può essere moltiplicato aggiungere al massimo", $pag) . "
 ...
 " . mex("letti aggiuntivi", $pag) . ".</td></tr></table>";
            ...
            if (!$chiedi_costi_aggiuntivi_di_pag_inserzione or strtoupper($chiedi_costi_aggiuntivi_di_pag_inserzione) == $SI) {
                $sel_SI = " selected";
                $sel_NO = "";
            } else {
                $sel_NO = " selected";
...
" . mex("Numero di colonne dei costi aggiuntivi", $pag) . ":
 <input type=\"text\" name=\"num_colonne_costi_agg\" size=\"3\" value=\"$val\">
            ...
            if (!$aggiungi_costi_fissi or strtoupper($aggiungi_costi_fissi) == $SI) {
                $sel_SI = " selected";
                $sel_NO = "";
            } else {
                $sel_NO = " selected";
...
" . mex("Costi aggiuntivi da mostrare ed eventuali loro nomi sostitutivi con cui mostrarli", $pag) . ":<br>
<table style=\"margin-left: auto; margin-right: auto;\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\">";
            $celle = 1;
            $num_colonne = 2;
 ...
 <input type=\"text\" name=\"$nome_costo_imposto\" value=\"$val\" size=\"22\"></td>";
            ...
            if (@is_array($categorie_combina)) {
                ...
                while (list($categoria, $id_costo_cat) = each($categorie_combina)) {
 ...
 <input type=\"text\" name=\"nome_cat_imp$id_costo_cat\" value=\"$val\" size=\"22\"></td>";
                    ...
                    $celle++;
                } # fine (list($categoria,$id_costo_cat) = each($categorie_combina))
...
<div style=\"font-size: smaller; text-align: center;\">(" . mex("le regole 1 di chiusura vengono sempre applicate", $pag) . ")</div>";
            if (!$mostra_frase_alternativa_regola1 or strtoupper($mostra_frase_alternativa_regola1) == $NO) {
                $check_NO = " checked";
                $check_SI = "";
            } else {
                $check_SI = " checked";
...
<label><input type=\"radio\" name=\"mostra_frase_alternativa_regola1\" value=\"SI\"$check_SI> " . mex("dai ancora disponibilità con questa frase alternativa", $pag) . "</label>:
 <input type=\"text\" name=\"frase_alternativa_regola1\" size=\"65\" value=\"$val\">
            ...
            if (!$mostra_caparra or strtoupper($mostra_caparra) == $SI) {
                $sel_SI = " selected";
                $sel_NO = "";
            } else {
                $sel_NO = " selected";
...
<option value=\"NO\"$sel_NO>" . mex("NO", $pag) . "</option>
            ...
            if (!$mostra_giorni_pieni or strtoupper($mostra_giorni_pieni) == $NO) {
                $sel_SI = "";
                $sel_NO = " selected";
            } else {
                $sel_NO = "";
...
<option value=\"NO\"$sel_NO>" . mex("NO", $pag) . "</option>
            ...
            if (!$mostra_richiesta_via_mail or strtoupper($mostra_richiesta_via_mail) == $SI) {
                $sel_NO = "";
                $sel_SI = " selected";
            } else {
                $sel_SI = "";
...
<option value=\"\">----</option>";
 ...
 <input type=\"text\"$readonly name=\"ind_email\" value=\"$ind_email\" size=\"25\"><br>";
            if (strtoupper($manda_copia_richiesta_email) == $SI) {
                $sel_NO = "";
                $sel_SI = " selected";
            } else {
                $sel_SI = "";
...
<select name=\"manda_copia_richiesta_email\">";
            if (C_RESTRIZIONI_DEMO_ADMIN != "SI") echo "<option value=\"SI\"$sel_SI>" . mex("SI", $pag) . "</option>";
            ...
            if (!defined("C_MASCHERA_EMAIL") or C_MASCHERA_EMAIL == "") {
                ...
                if (strtoupper($maschera_email) == $NO) {
                    $sel_SI = "";
                    $sel_NO = " selected";
                } else {
                    $sel_NO = "";
...
<table>";
            ...
            if ($chiedi_cognome != $SI and $chiedi_cognome != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_cognome == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_nome != $SI and $chiedi_nome != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_email != $SI and $chiedi_email != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_sesso != $SI and $chiedi_sesso != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_datanascita != $SI and $chiedi_datanascita != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_datanascita == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_documento != $SI and $chiedi_documento != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_documento == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_nazione != $SI and $chiedi_nazione != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_nazione == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_regione != $SI and $chiedi_regione != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_regione == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_citta != $SI and $chiedi_citta != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_via != $SI and $chiedi_via != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_numcivico != $SI and $chiedi_numcivico != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_numcivico == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_cap != $SI and $chiedi_cap != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_telefono != $SI and $chiedi_telefono != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_telefono == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_telefono2 != $SI and $chiedi_telefono2 != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_telefono2 == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_telefono3 != $SI and $chiedi_telefono3 != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_telefono3 == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_fax != $SI and $chiedi_fax != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_codfiscale != $SI and $chiedi_codfiscale != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_codfiscale == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_partitaiva != $SI and $chiedi_partitaiva != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_partitaiva == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_commento != $SI and $chiedi_commento != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_commento == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_oracheckin != $SI and $chiedi_oracheckin != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_oracheckin == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<option value=\"NO\"$sel_NO>$f_non_chiedere</option>
            ...
            if ($chiedi_metodopagamento != $SI and $chiedi_metodopagamento != $NO) {
                $sel_SI = "";
                $sel_opz = " selected";
                $sel_NO = "";
            }
            if ($chiedi_metodopagamento == $SI) {
                $sel_SI = " selected";
                $sel_opz = "";
                $sel_NO = "";
            }
...
<input type=\"hidden\" name=\"num_metodi_pagamento\" value=\"$num_metodi_pagamento\">
            ...
            echo "" . mex("Campi della form personalizzati", $pag) . ":<br>
...
<option value=\"\">" . mex("aggiunto al commento", $pag) . "</option>";
            ...
            echo "</td><td style=\"width: 20px;\"></td><td valign=\"bottom\">";
            if ($num_campi_pers > 1) echo "<input class=\"sbutton\" type=\"submit\" name=\"eliminacampipers\" value=\"" . mex("-", $pag) . "\">&nbsp;";
            echo "<input class=\"sbutton\" type=\"submit\" name=\"aggiungicampipers\" value=\"" . mex("+", $pag) . "\">
...
" . mex("Condizioni da accettare nella form", $pag) . " (" . mex("nomi dall'utente delle liste", $pag) . "):<br>
<table><tr><td style=\"width: 25px;\"></td><td valign=\"top\">";
...
<option value=\"opzionale\"$sel_opz>$f_opzionale, " . mex("aggiunto al commento", $pag) . "</option>";
                ...
                if ($num_campi_doc_cond > 1) echo "&nbsp;<input class=\"sbutton\" type=\"submit\" name=\"eliminacampicond\" value=\"" . mex("-", $pag) . "\">";
                echo "&nbsp;<input class=\"sbutton\" type=\"submit\" name=\"aggiungicampicond\" value=\"" . mex("+", $pag) . "\">
<input type=\"hidden\" name=\"num_campi_doc_cond\" value=\"$num_campi_doc_cond\"></td></tr></table>";
            ...
            if (@is_dir("./includes/templates/pay")) {
                if (!$mostra_bottone_paypal or strtoupper($mostra_bottone_paypal) == $NO) {
                    $sel_SI = "";
                    $sel_NO = " selected";
                } else {
                    $sel_NO = "";
...
" . mex("Tag di chiusura dei font della tabella", $pag) . ":
 <input type=\"text\" name=\"chiusura_font_quadro_disponibilita\" value=\"$chiusura_font_quadro_disponibilita\" size=\"25\"><br>";
            if (!$mostra_numero_liberi_quadro_disponibilita or strtoupper($mostra_numero_liberi_quadro_disponibilita) == $NO) {
                $sel_SI = "";
                $sel_NO = " selected";
            } else {
                $sel_NO = "";
...
<option value=\"NO\"$sel_NO>" . mex("NO", $pag) . "</option>
            ...
            if (!$allinea_disponibilita_con_arrivo and strtoupper($allinea_disponibilita_con_arrivo) != $SI and $allinea_disponibilita_con_arrivo != "SI") {
                $sel_SI = "";
                $sel_NO = " selected";
            } else {
                $sel_NO = "";
...
<option value=\"NO\"$sel_NO>" . mex("NO", $pag) . "</option>
            ...
            if (!$mostra_calendario_scelta_date or strtoupper($mostra_calendario_scelta_date) != $NO) {
                $sel_SI = " selected";
                $sel_NO = "";
            } else {
                $sel_NO = " selected";
...
" . mex("Tag html di chiusura per la formattazione delle font rosse", $pag) . ":
 ...
 <input type=\"text\" name=\"file_css_frame\" size=\"35\" value=\"$file_css_frame\"><br>";
            if (!$apri_nuova_finestra_da_frame or strtoupper($apri_nuova_finestra_da_frame) != $SI) {
                $sel_SI = "";
                $sel_NO = " selected";
            } else {
                $sel_NO = "";
...
<input type=\"text\" name=\"T_PHPR_TAB_PRE\" maxlength=\"8\" size=\"9\">
            ...
            } # fine if (C_BACKUP_E_MODELLI_CON_NUOVI_DATI != "NO")
...
<button class=\"$template_class\" type=\"submit\" name=\"form_$template_name\" value=\"1\"><div>" . $nome_modello_ext . "</div></button>
            ...
            ksort($modelli);
            reset($modelli);
            while (list($modello_ext, $val_i) = each($modelli)) {
                include("./includes/templates/$modello_ext/name.php");
                if ($template_name_show['tpl_type'] != "interconnection") {
                    if ($template_file_name['ita']) $nome_file = $template_file_name['ita'];
                    else $nome_file = "ita_" . $template_file_name['en'];
            ...
            } # fine while (list($modello_ext,$val_i) = each($modelli))
            closedir($templates_dir);

            if ($num_cart > 1 and @is_array($mod_presenti_vett)) {
...
<button class=\"xdoc\" type=\"submit\"><div>" . mex("Importa", $pag) . "</div></button>
            ...
            } # fine if ($num_cart > 1 and @is_array($mod_presenti_vett))

            if (@is_array($mod_presenti_vett)) {
                echo "<hr style=\"width: 95%\"><div style=\"text-align: center;\">
<form accept-charset=\"utf-8\" method=\"post\" action=\"crea_modelli.php\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
