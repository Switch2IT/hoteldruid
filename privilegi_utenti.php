...
<input class=\"sbutton\" type=\"submit\" name=\"continua\" value=\"" . mex("Continua", $pag) . "\">
                ...
                if ($crea_interconnessioni == "s" or $crea_interconnessioni == "n") $nuovi_priv_mod_pers = substr($nuovi_priv_mod_pers, 0, 3) . $crea_interconnessioni;
...
<input type=\"hidden\" name=\"modifica_privilegi_globali\" value=\"SI\">";
 ...
 <label><input type=\"radio\" name=\"modifica_pers\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        unset($b_NO);
        unset($b_slash_NO);
        if (substr($priv_mod_pers, 1, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_mod_pers, 1, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"crea_backup\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        unset($b_NO);
        unset($b_slash_NO);
        if (substr($priv_mod_pers, 3, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_mod_pers, 3, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"crea_interconnessioni\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        unset($b_NO);
        unset($b_slash_NO);
        if (substr($priv_mod_pers, 2, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_mod_pers, 2, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"modifica_doc\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br><br>";
        ...
        if (substr($priv_ins_clienti, 0, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"inserimento_clienti\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        if (substr($priv_ins_clienti, 2, 1) == "p" or substr($priv_ins_clienti, 2, 1) == "g") {
            $checked_PR = " checked";
            $b_PR = "<b>";
            $b_slash_PR = "</b>";
        }
        ...
        if (substr($priv_ins_clienti, 2, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"vedi_clienti\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        if (substr($priv_ins_clienti, 1, 1) == "p" or substr($priv_ins_clienti, 1, 1) == "g") {
            $checked_PR = " checked";
            $b_PR = "<b>";
            $b_slash_PR = "</b>";
        }
        ...
        if (substr($priv_ins_clienti, 1, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"modifica_clienti\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        unset($b_NO);
        unset($b_slash_NO);
        if (substr($priv_ins_clienti, 3, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_ins_clienti, 3, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"vedi_telefoni\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        unset($b_NO);
        unset($b_slash_NO);
        if (substr($priv_ins_clienti, 4, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_ins_clienti, 4, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"vedi_indirizzo\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label>";
        ...
        unset($b_PRE);
        unset($b_slash_PRE);
        if (substr($prefisso_clienti[0], 0, 1) == "p") {
            $checked_PRE = " checked";
            $b_PRE = "<b>";
            $b_slash_PRE = "</b>";
        }
        if (substr($prefisso_clienti[0], 0, 1) == "s") {
            $checked_SUF = " checked";
            $b_SUF = "<b>";
            $b_slash_SUF = "</b>";
        }
        if (substr($prefisso_clienti[0], 0, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
...
" . mex("Testo del prefisso/suffisso dei clienti", $pag) . ": <input type=\"text\" name=\"testo_prefisso_clienti\" size=\"15\" value=\"" . $prefisso_clienti[1] . "\"><br><br>";
        ...
        unset($b_NO);
        unset($b_slash_NO);
        if (substr($priv_messaggi, 0, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_messaggi, 0, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"vedi_messaggi\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        unset($b_NO);
        unset($b_slash_NO);
        if (substr($priv_messaggi, 1, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_messaggi, 1, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"ins_messaggi\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label>
        ...
        unset($b_NO);
        unset($b_slash_NO);
        if (substr($casse_consentite, 0, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($casse_consentite, 0, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
...
<div style=\"text-align: center;\"><table style=\"margin-left: auto; margin-right: auto;\" border=1 cellspacing=1 cellpadding=0>";
        ...
        for ($num1 = 0; $num1 < $num_casse; $num1++) {
            ...
            if ($cassa_selezionata[$id_cassa] == "SI") {
                $checked = " checked";
                $tag_b = "<b>";
                $fine_tag_b = "</b>";
            } else {
...
$tag_b$nome_cassa$fine_tag_b</label>&nbsp;</td>";
        ...
        unset($sel_PR);
        unset($sel_GR);
        if (substr($priv_inventario, 0, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_inventario, 0, 1) == "p" or substr($priv_inventario, 0, 1) == "g") {
            $checked_PR = " checked";
            $b_PR = "<b>";
            $b_slash_PR = "</b>";
        }
        ...
        if (substr($priv_inventario, 0, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"vedi_beni_inv\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        unset($b_NO);
        unset($b_slash_NO);
        if (substr($priv_inventario, 1, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_inventario, 1, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"ins_beni_inv\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label>
        ...
        unset($sel_PR);
        unset($sel_GR);
        if (substr($priv_inventario, 2, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_inventario, 2, 1) == "p" or substr($priv_inventario, 2, 1) == "g") {
            $checked_PR = " checked";
            $b_PR = "<b>";
            $b_slash_PR = "</b>";
        }
        ...
        if (substr($priv_inventario, 2, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"vedi_inv_mag\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        unset($b_NO);
        unset($b_slash_NO);
        if (substr($priv_inventario, 3, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_inventario, 3, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"ins_mag\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        unset($sel_PR);
        unset($sel_GR);
        if (substr($priv_inventario, 4, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_inventario, 4, 1) == "p" or substr($priv_inventario, 4, 1) == "g") {
            $checked_PR = " checked";
            $b_PR = "<b>";
            $b_slash_PR = "</b>";
        }
        ...
        if (substr($priv_inventario, 4, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"ins_beni_in_mag\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        unset($sel_PR);
        unset($sel_GR);
        if (substr($priv_inventario, 5, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_inventario, 5, 1) == "p" or substr($priv_inventario, 5, 1) == "g") {
            $checked_PR = " checked";
            $b_PR = "<b>";
            $b_slash_PR = "</b>";
        }
        ...
        if (substr($priv_inventario, 5, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"mod_beni_in_mag\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        unset($sel_PR);
        unset($sel_GR);
        if (substr($priv_inventario, 6, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_inventario, 6, 1) == "p" or substr($priv_inventario, 6, 1) == "g") {
            $checked_PR = " checked";
            $b_PR = "<b>";
            $b_slash_PR = "</b>";
        }
        ...
        if (substr($priv_inventario, 6, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"vedi_inv_app\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        unset($sel_PR);
        unset($sel_GR);
        if (substr($priv_inventario, 7, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_inventario, 7, 1) == "p" or substr($priv_inventario, 7, 1) == "g") {
            $checked_PR = " checked";
            $b_PR = "<b>";
            $b_slash_PR = "</b>";
        }
        ...
        if (substr($priv_inventario, 7, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
 ...
 <label><input type=\"radio\" name=\"ins_beni_in_app\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
        ...
        unset($sel_PR);
        unset($sel_GR);
        if (substr($priv_inventario, 8, 1) == "s") {
            $checked_SI = " checked";
            $b_SI = "<b>";
            $b_slash_SI = "</b>";
        }
        if (substr($priv_inventario, 8, 1) == "p" or substr($priv_inventario, 8, 1) == "g") {
            $checked_PR = " checked";
            $b_PR = "<b>";
            $b_slash_PR = "</b>";
        }
        ...
        if (substr($priv_inventario, 8, 1) == "n") {
            $checked_NO = " checked";
            $b_NO = "<b>";
            $b_slash_NO = "</b>";
        }
...
<input type=\"hidden\" name=\"modifica_privilegi_anno\" value=\"$anno_mostra\">";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($regole1_consentite, 0, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($regole1_consentite, 0, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
...
<table style=\"margin-left: auto; margin-right: auto;\" border=\"1\"><tr>$n_costi_agg_imposti";
                ...
                for ($num2 = 0; $num2 < $num_regole; $num2++) {
                    ...
                    if ($motivazioni_presenti[$motivazione] != "SI") {
                        ...
                        unset($b_SI);
                        unset($b_slash_SI);
                        if ($motivazioni_selezionate[$motivazione] == "SI") {
                            $checked_SI = " checked";
                            $b_SI = "<b>";
                            $b_slash_SI = "</b>";
                        }
...
<input type=\"hidden\" name=\"num_motivazioni$anno_mostra\" value=\"$num_motivazioni\">";
                ...
                if (substr($regole1_consentite, 1, 1) == "s") {
                    $checked_SEMPRE = " checked";
                    $b_SEMPRE = "<b>";
                    $b_slash_SEMPRE = "</b>";
                }
                if (substr($regole1_consentite, 1, 1) == "r") {
                    $checked_SEL = " checked";
                    $b_SEL = "<b>";
                    $b_slash_SEL = "</b>";
                }
                if (substr($regole1_consentite, 1, 1) == "n") {
                    $checked_NONSEL = " checked";
                    $b_NONSEL = "<b>";
                    $b_slash_NONSEL = "</b>";
                }
                if (substr($regole1_consentite, 1, 1) == "m") {
                    $checked_MAI = " checked";
                    $b_MAI = "<b>";
                    $b_slash_MAI = "</b>";
                }
                if (substr($regole1_consentite, 1, 1) == "f") {
                    $checked_FISSINSEL = " checked";
                    $b_FISSINSEL = "<b>";
                    $b_slash_FISSINSEL = "</b>";
                }
...
<td><label for=\"ar1_f\">$b_FISSINSEL" . mex("Mai, ma non spostare altre prenotazioni in periodi delle regole non selezionate se non vi si possono inserire prenotazioni", $pag) . "$b_slash_FISSINSEL</label></td></tr>
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($tariffe_consentite, 0, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($tariffe_consentite, 0, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
...
<table style=\"margin-left: auto; margin-right: auto;\">";
                ...
                for ($numtariffa = 1; $numtariffa <= $numero_tariffe; $numtariffa++) {
                    ...
                    if ($tariffa_selezionata[$numtariffa] == "SI") {
                        $checked = " checked";
                        $tag_b = "<b style=\"font-weight: normal; text-decoration: underline;\">";
                        $fine_tag_b = "</b>";
                    } else {
                        $checked = "";
                        $tag_b = "";
...
<input type=\"hidden\" name=\"numero_tariffe\" value=\"$numero_tariffe\">";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($costi_agg_consentiti, 0, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($costi_agg_consentiti, 0, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
...
<table style=\"margin-left: auto; margin-right: auto;\"><tr>";
                for ($num2 = 0; $num2 < $dati_ca['num']; $num2++) {
                    ...
                    if ($costo_agg_selezionato[($idntariffe)] == "SI") {
                        $checked = " checked";
                        $tag_b = "<b style=\"font-weight: normal; text-decoration: underline;\">";
                        $fine_tag_b = "</b>";
                    } else {
...
<small>$tag_b" . mex("$tipo_costo", $pag) . " $nome_costo$fine_tag_b</small></label></td>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($contratti_consentiti, 0, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($contratti_consentiti, 0, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
...
<div style=\"text-align: center;\"><table style=\"margin-left: auto; margin-right: auto;\" border=1 cellspacing=1 cellpadding=0>";
                ...
                for ($num_contratto = 1; $num_contratto <= $max_contr; $num_contratto++) {
                    if ($num_colonna == 1) echo "<tr>";
                    if ($contratto_selezionato[$num_contratto] == "SI") {
                        $checked = " checked";
                        $tag_b = "<b style=\"font-weight: normal; text-decoration: underline;\">";
                        $fine_tag_b = "</b>";
                    } else {
...
$tag_b<small>" . mex("documento", $pag) . "$num_contratto</small>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($contratti_consentiti, 1, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($contratti_consentiti, 1, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
...
<br><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_prenota, 0, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_prenota, 0, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
...
<table><tr><td style=\"width: 30px;\"></td><td>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_prenota, 1, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_prenota, 1, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_assegnazione_app$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_prenota, 2, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_prenota, 2, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_conferma_prenota$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_prenota, 3, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_prenota, 3, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_sconto$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_prenota, 4, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_prenota, 4, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_caparra$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_prenota, 10, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_prenota, 10, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_checkin$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_prenota, 5, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_prenota, 5, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_costi_agg_prenota$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_prenota, 6, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_prenota, 6, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_commento$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_prenota, 12, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_prenota, 12, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_comm_pers$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_prenota, 11, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_prenota, 11, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_origine_prenota$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_prenota, 7, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_prenota, 7, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_num_persone$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_prenota, 8, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_prenota, 8, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_passato$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NV);
                unset($b_slash_NV);
                if (substr($priv_ins_prenota, 9, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_prenota, 9, 1) == "m") {
                    $checked_NV = " checked";
                    $b_NV = "<b>";
                    $b_slash_NV = "</b>";
                }
                if (substr($priv_ins_prenota, 9, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_multiple$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($sel_PR);
                unset($sel_GR);
                if (substr($priv_mod_prenota, 0, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 0, 1) == "p" or substr($priv_mod_prenota, 0, 1) == "g") {
                    $checked_PR = " checked";
                    $b_PR = "<b>";
                    $b_slash_PR = "</b>";
                }
                ...
                if (substr($priv_mod_prenota, 0, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
...
<table cellspacing=0 cellpadding=0><tr><td style=\"width: 30px;\" rowspan=2></td><td colspan=2>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 22, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 22, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_cliente$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 1, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 1, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_date_prenota$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_AS);
                unset($b_slash_AS);
                if (substr($priv_mod_prenota, 2, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 2, 1) == "a") {
                    $checked_AS = " checked";
                    $b_AS = "<b>";
                    $b_slash_AS = "</b>";
                }
                if (substr($priv_mod_prenota, 2, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_app_prenota$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 23, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 23, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_pren_comp$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_RE);
                unset($b_slash_RE);
                if (substr($priv_mod_prenota, 3, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 3, 1) == "r") {
                    $checked_RE = " checked";
                    $b_RE = "<b>";
                    $b_slash_RE = "</b>";
                }
                if (substr($priv_mod_prenota, 3, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_tariffa$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 4, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 4, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_num_persone$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 25, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 25, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_vedi_comm$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 5, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 5, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_commento$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label></div>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 26, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 26, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_comm_pers$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 24, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 24, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_origine_prenota$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 20, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 20, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_checkin$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 6, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 6, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_sconto$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 7, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 7, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_caparra$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 8, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 8, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
...
# <label><input type=\"radio\" name=\"modp_conferma$anno_mostra\" value=\"n\"$checked_NO>$b_NO".mex("No",$pag)."$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 10, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 10, 1) == "c") {
                    $checked_CONF = " checked";
                    $b_CONF = "<b>";
                    $b_slash_CONF = "</b>";
                }
                if (substr($priv_mod_prenota, 10, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
...
" . mex("Inserire sempre i pagamenti delle prenotazioni nella cassa", $pag) . ":
 <select name=\"modp_cassa_pagamenti$anno_mostra\">$opt_casse</select>
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 21, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 21, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_codice$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 11, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 11, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
...
echo "".mex("Prenotazioni modificabili solo con uscita",$pag).":
 ...
 <label><input type=\"radio\" name=\"modp_dip_uscita$anno_mostra\" value=\"s\"$checked_SI>$b_SI".mex("Indifferentemente",$pag)."$b_slash_SI</label><br>";*/
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 12, 3) != "000") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_attiva_ore_mod$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_FU);
                unset($b_slash_FU);
                if (substr($priv_mod_prenota, 18, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 18, 1) == "f") {
                    $checked_FU = " checked";
                    $b_FU = "<b>";
                    $b_slash_FU = "</b>";
                }
                if (substr($priv_mod_prenota, 18, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
...
" . mex("Possibilità di cancellare le prenotazioni", $pag) . ":
 ...
 <label><input type=\"radio\" name=\"modp_canc$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 19, 1) == "n") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_mod_prenota, 19, 1) == "s") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_canc_dopo_conf$anno_mostra\" value=\"s\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_mod_prenota, 15, 3) != "000") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"modp_attiva_ore_canc$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_costi, 0, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_costi, 0, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_spese$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_costi, 1, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_costi, 1, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_entrate$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_CH);
                unset($b_slash_CH);
                if (substr($priv_ins_costi, 2, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_costi, 2, 1) == "c") {
                    $checked_CH = " checked";
                    $b_CH = "<b>";
                    $b_slash_CH = "</b>";
                }
                if (substr($priv_ins_costi, 2, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"sottrai_entrate$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("Mai", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_CH);
                unset($b_slash_CH);
                if (substr($priv_ins_costi, 3, 1) == "u") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_costi, 3, 1) == "c") {
                    $checked_CH = " checked";
                    $b_CH = "<b>";
                    $b_slash_CH = "</b>";
                }
                if (substr($priv_ins_costi, 3, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"persona_spese$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("Nessuno", $pag) . "$b_slash_NO</label><br><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_tariffe, 0, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_tariffe, 0, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"mod_tariffe$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($sel_PR);
                unset($sel_GR);
                if (substr($priv_ins_tariffe, 1, 1) == "s" or substr($priv_ins_tariffe, 1, 1) == "g") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                ...
                if (substr($priv_ins_tariffe, 1, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"ins_costi_agg$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_tariffe, 2, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_tariffe, 2, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"mod_costi_agg$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_NO);
                unset($b_slash_NO);
                if (substr($priv_ins_tariffe, 3, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_ins_tariffe, 3, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"canc_costi_agg$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br><br>";
                ...
                unset($sel_APR);
                unset($sel_AGR);
                if (substr($priv_vedi_tab, 0, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_vedi_tab, 0, 1) == "p" or substr($priv_vedi_tab, 0, 1) == "q" or substr($priv_vedi_tab, 0, 1) == "r" or substr($priv_vedi_tab, 0, 1) == "g") {
                    $checked_PR = " checked";
                    $b_PR = "<b style=\"font-weight: normal; text-decoration: underline;\">";
                    $b_slash_PR = "</b>";
                }
...
" . mex("Mostrare le prenotazioni non permesse come", $pag) . ":
 ...
 <option value=\"f\"$sel_FUT>" . mex("oscurate", $pag) . " (" . mex("solo correnti e future", $pag) . ")</otion>
                ...
                unset($sel_PR);
                unset($sel_GR);
                if (substr($priv_vedi_tab, 1, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_vedi_tab, 1, 1) == "p" or substr($priv_vedi_tab, 1, 1) == "g") {
                    $checked_PR = " checked";
                    $b_PR = "<b>";
                    $b_slash_PR = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"vedi_tab_tutte_prenota$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($sel_PR);
                unset($sel_GR);
                if (substr($priv_vedi_tab, 2, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_vedi_tab, 2, 1) == "p" or substr($priv_vedi_tab, 2, 1) == "g") {
                    $checked_PR = " checked";
                    $b_PR = "<b>";
                    $b_slash_PR = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"vedi_tab_costi$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($sel_PR);
                unset($sel_GR);
                if (substr($priv_vedi_tab, 3, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_vedi_tab, 3, 1) == "p" or substr($priv_vedi_tab, 3, 1) == "g") {
                    $checked_PR = " checked";
                    $b_PR = "<b>";
                    $b_slash_PR = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"vedi_tab_tariffe$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_PR);
                unset($b_slash_PR);
                if (substr($priv_vedi_tab, 4, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_vedi_tab, 4, 1) == "p") {
                    $checked_PR = " checked";
                    $b_PR = "<b>";
                    $b_slash_PR = "</b>";
                }
                if (substr($priv_vedi_tab, 4, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"vedi_tab_regole$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($sel_PR);
                unset($sel_GR);
                if (substr($priv_vedi_tab, 5, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_vedi_tab, 5, 1) == "p" or substr($priv_vedi_tab, 5, 1) == "g") {
                    $checked_PR = " checked";
                    $b_PR = "<b style=\"font-weight: normal; text-decoration: underline;\">";
                    $b_slash_PR = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"vedi_tab_appartamenti$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($b_PR);
                unset($b_slash_PR);
                if (substr($priv_vedi_tab, 7, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_vedi_tab, 7, 1) == "p") {
                    $checked_PR = " checked";
                    $b_PR = "<b>";
                    $b_slash_PR = "</b>";
                }
                if (substr($priv_vedi_tab, 7, 1) == "n") {
                    $checked_NO = " checked";
                    $b_NO = "<b>";
                    $b_slash_NO = "</b>";
                }
 ...
 <label><input type=\"radio\" name=\"vedi_tab_doc$anno_mostra\" value=\"n\"$checked_NO>$b_NO" . mex("No", $pag) . "$b_slash_NO</label><br>";
                ...
                unset($sel_APR);
                unset($sel_AGR);
                if (substr($priv_vedi_tab, 6, 1) == "s") {
                    $checked_SI = " checked";
                    $b_SI = "<b>";
                    $b_slash_SI = "</b>";
                }
                if (substr($priv_vedi_tab, 6, 1) == "p" or substr($priv_vedi_tab, 6, 1) == "q" or substr($priv_vedi_tab, 6, 1) == "r" or substr($priv_vedi_tab, 6, 1) == "g") {
                    $checked_PR = " checked";
                    $b_PR = "<b style=\"font-weight: normal; text-decoration: underline;\">";
                    $b_slash_PR = "</b>";
                }
