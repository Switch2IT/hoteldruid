...
# Se non c'è posto per questo numero di persone provo ad aggiungere un costo con un letto aggiuntivo
                            ...
                            if ($num_app_richiesti != 1 or $num_tipologie > 1) {
                                ...
                                if (!${"app_richiesti" . $n_t}) $lista_app_richiesti = ",tutti,,";
                                else while (list($key, $val) = each(${"app_richiesti" . $n_t})) if ($val == "SI") $lista_app_richiesti .= $key . ",";
...
# Effettuo gli spostamenti e faccio i controlli (appartamento di destinazione assegnabile, esistente e vuoto)
                            ...
                            esegui_query("update $tabletransazioni set dati_transazione10 = 'SI' where idtransazioni = '$id_transazione' and idsessione = '$id_sessione'");
