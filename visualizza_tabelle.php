...
if ($tipo_tabella == "appartamenti") $base_js = 1;
...
values ('$id_transazione','$id_sessione','tab_p','$anno','" . aggslashdb($pag_pren_corr) . "','" . aggslashdb($pag_pren_succ) . "','" . aggslashdb($pag_pren_prec) . "','" . aggslashdb($ordine_prenota) . "','" . aggslashdb($mos_tut_dat) . "','" . aggslashdb($cerca_prenota) . "','" . aggslashdb($opz_cerc_pren) . "','" . aggslashdb($cerca_ini) . "','" . aggslashdb($cerca_fine) . "','" . aggslashdb($id_utente_vedi) . "','" . aggslashdb($senza_colori) . "','" . aggslashdb($lista_prenota) . "','" . aggslashdb($sel_tab_prenota) . "','$ultimo_accesso')");
                ...
                for ($num1 = 0; $num1 < $num_colonne_selezionate; $num1++) {
                    ...
                    if ($colonna_selezionata[0] == "ds") {
                        $colonna_docsalvati = "SI";
                        $prendi_doc = 1;
                    }
                    ...
                    if ($colonna_selezionata[0] == "gr") {
                        ...
                        for ($num2 = 3; $num2 < count($colonna_selezionata); $num2++) {
                            ...
                            if ($dati_col_gr[0] == "pi") {
                                $col_gr_piano[$num_gr_tab] = "SI";
                                $prendi_app = 1;
                            }
                            if ($dati_col_gr[0] == "ka") {
                                $col_gr_casa[$num_gr_tab] = "SI";
                                $prendi_app = 1;
                            }
                            ...
                            if ($dati_col_gr[0] == "ds") {
                                $col_gr_docsalvati[$num_gr_tab] = "SI";
                                $prendi_doc = 1;
                            }
                ...
                if ($priv_vedi_tab_prenotazioni == "p" or $priv_vedi_tab_prenotazioni == "g") {
                    ...
                    if ($priv_vedi_tab_prenotazioni == "g") {
                        reset($utenti_gruppi);
                        while (list($idut_gr, $val) = each($utenti_gruppi)) if ($idut_gr != $id_utente_vedi) $condizione_prenota_proprie .= " or utente_inserimento = '$idut_gr'";
                    } # fine if ($priv_vedi_tab_prenotazioni == "g")
                ...
                if ($num_prenotazioni_successive != 0) {
                    $num_tabelle = $num_tabelle + 1;
                }
                ...
                if (($cerca_prenota and $cerca_prenota != "tutte") or $subtotale_selezionate) {
                    ...
                    if ($cerca_prenota and $cerca_prenota != "tutte") {
                        ...
                        if ($num_c_idinizioperiodo == 0) {
                            $c_idinizioperiodo = 10000;
                        } else {
                            $c_idinizioperiodo = risul_query($c_idinizioperiodo, 0, 'idperiodi');
                        }
                        if ($cerca_fine) {
                            ...
                            if ($num_c_idfineperiodo == 0) {
                                $c_idfineperiodo = 10000;
                            } else {
                                $c_idfineperiodo = risul_query($c_idfineperiodo, 0, 'idperiodi');
                            }
                        } # fine if ($cerca_fine)
...
#$iddata_inizio_parziale = risul_query($prenotazioni,(($num1 -1)*$num_vedi_in_tab),'iddatainizio');
                    ...
                    echo "<table class=\"$class\" id=\"tpren$num_tab\" style=\"width: 3px; background-color: $colore_sfondo; margin-left: auto; margin-right: auto;\" border=\"$t1border\" cellspacing=\"$t1cellspacing\" cellpadding=\"$t1cellpadding\">
<tr><td";
...
#$checkbox_modifica = "&nbsp;";
                        ...
                        if ($tabella_unica_riassuntiva or (($num1 + 1) > (($pagina_prenota - 1) * $num_vedi_in_tab) and ($num1 + 1) <= (($pagina_prenota) * $num_vedi_in_tab))) {
                            ...
                            if ($priv_vedi_commento == "n" or !strcmp($commento, "")) {
                                $commento = "&nbsp;";
                            }
                            ...
                            if ($colonna_docsalvati) {
                                ...
                                if (@is_array($contratti_prenota[$numero])) {
                                    ...
                                    while (list($num_contr, $arr_num_doc) = each($contratti_prenota[$numero])) {
                                        $contr_doc_num = $arr_num_doc;
                                        while (list($num_doc, $file_doc) = each($contr_doc_num)) {
                                        ...
                                        } # fine while (list($num_contr,$arr_num_doc) = each($contr_doc_num))
                                    } # fine while (list($num_contr,$arr_num_doc) = each($contratti_prenota[$numero]))
                            ...
                            for ($num2 = 0; $num2 < $num_gr_tab; $num2++) {
                                ...
                                $spazio = "";
                                $colonne_costi .= "<td style=\"font-size: x-small;\">";
                                if ($col_gr_settimane[$num2] == "SI") {
                                    $colonne_costi .= "$numero_settimane";
                                    $spazio = $separatore;
                                }
                                if ($col_gr_caparra[$num2] == "SI") {
                                    $colonne_costi .= "$spazio$caparra_p";
                                    $spazio = $separatore;
                                }
                                if ($col_gr_commissioni[$num2] == "SI") {
                                    $colonne_costi .= "$spazio$commissioni_p";
                                    $spazio = $separatore;
                                }
                                if ($col_gr_restocomm[$num2] == "SI") {
                                    $colonne_costi .= "$spazio$restocomm_p";
                                    $spazio = $separatore;
                                }
                                if ($col_gr_pagato[$num2] == "SI") {
                                    $colonne_costi .= "$spazio$pagato_p";
                                    $spazio = $separatore;
                                }
                                if ($col_gr_dapagare[$num2] == "SI") {
                                    $colonne_costi .= "$spazio$da_pagare_p";
                                    $spazio = $separatore;
                                }
                                if ($col_gr_nometariffa[$num2] == "SI") {
                                    $colonne_costi .= "$spazio$nome_tariffa";
                                    $spazio = $separatore;
                                }
                                if ($col_gr_appartamento[$num2] == "SI") {
                                    $colonne_costi .= "$spazio$appartamento";
                                    $spazio = $separatore;
                                }
                                if ($col_gr_piano[$num2] == "SI") {
                                    $colonne_costi .= $spazio . $piano_app[$appartamento];
                                    $spazio = $separatore;
                                }
                                if ($col_gr_casa[$num2] == "SI") {
                                    $colonne_costi .= $spazio . $casa_app[$appartamento];
                                    $spazio = $separatore;
                                }
                                if ($col_gr_persone[$num2] == "SI") {
                                    $colonne_costi .= "$spazio$num_persone";
                                    if ($n_letti_agg != 0) {
                                        $colonne_costi .= "+$n_letti_agg";
                                    }
                                    $spazio = $separatore;
                                } # fine if ($col_gr_persone[$num2] == "SI")
                                if ($col_gr_commento[$num2] == "SI") {
                                    $colonne_costi .= "$spazio$commento";
                                    $spazio = $separatore;
                                }
                                if ($col_gr_origine_prenota[$num2] == "SI") {
                                    $colonne_costi .= "$spazio$origine_prenota";
                                    $spazio = $separatore;
                                }
                                if ($col_gr_docsalvati[$num2] == "SI") {
                                    $colonne_costi .= "$spazio$documenti_salvati";
                                    $spazio = $separatore;
                                }
                                if ($col_gr_datainserimento[$num2] == "SI") {
                                    $colonne_costi .= "$spazio$datainserimento_f";
                                    $spazio = $separatore;
                                }
                                if ($col_gr_utenteinserimento[$num2] == "SI") {
                                    $colonne_costi .= "$spazio$nome_utente_inserimento";
                                    $spazio = $separatore;
                                }
                    ...
                    if ($riga_cassa and !$tabella_unica_riassuntiva and $priv_vedi_tab_costi != "n") {
                        if ($priv_vedi_tab_costi == "p" or $priv_vedi_tab_costi == "g") {
                            ...
                            if ($priv_vedi_tab_costi == "g") {
                                reset($utenti_gruppi);
                                while (list($idut_gr, $val) = each($utenti_gruppi)) if ($idut_gr != $id_utente) $condizione_costi_propri .= " or utente_inserimento = '$idut_gr'";
...
<button class=\"cont\" type=\"submit\"><div>OK</div></button>
            ...
            if ($mostra_tab_costi != "NO") {
                ...
                if (@is_array($casse_mostra)) {
                    while (list($id_cassa, $nome_cassa) = each($casse_mostra)) {
...
#$datainserimento = preg_replace("/$string/","",$datainserimento);
                                ...
                                if ($provenienza_costo == "p") {
                                    $nome_costo = $nome_costo . "(*)";
                                }
                                if ($mostra_tot_giorn or $mostra_tot_mens) {
...
<hr style=\"width: 95%\">";
                    ...
                    } # fine while (list($id_cassa,$nome_cassa) = each($casse_mostra))
...
<button class=\"resp\" type=\"submit\"><div>" . mex("Storia entrate-uscite prenotazioni", $pag) . "</div></button>
        ...
        if ($tipo_tabella == "periodi" and $priv_vedi_tab_periodi != "n") {
            ...
            if ($priv_vedi_tab_periodi == "g") {
                ...
                while (list($idut_gr, $val) = each($attiva_tariffe_consentite_gr)) if ($val == "n") $attiva_tariffe_consentite = "n";
                unset($tariffe_consentite_vett);
                while (list($idut_gr, $val) = each($tariffe_consentite_vett_gr)) {
                    if (is_array($val)) {
                        $tar_cons_vett_tmp = $val;
                        while (list($tar, $val) = each($tar_cons_vett_tmp)) if ($val == "SI") $tariffe_consentite_vett[$tar] = "SI";
                    } # fine if (is_array($val))
                } # fine (list($idut_gr,$val) = each($tariffe_consentite_vett_gr))
...
<button class=\"cont\" type=\"submit\"><div>OK</div></button>
                ...
                if ($cancella_anno and $id_utente == 1 and (C_CANCELLA_ANNO_ATTUALE != "NO" or $anno != $anno_attuale)) {
                    if (!$continua) {
...
<button class=\"cont\" type=\"submit\"><div>OK</div></button>
                        ...
                        if ($ins_form_tabella == "SI" and $priv_mod_tariffe != "n") {
                            $mostra_pag_principale = "NO";
                            $tabelle_lock = array($tablenometariffe, $tableperiodi);
                            $tabelle_lock = lock_tabelle($tabelle_lock);
                            $rigatariffe = esegui_query("select * from $tablenometariffe where idntariffe = 1 ");
                            ...
                            for ($num1 = 0; $num1 < $num_periodi; $num1++) {
                                ...
                                for ($num2 = 1; $num2 <= $numero_tariffe; $num2++) {
                                    if (($attiva_tariffe_consentite_ut == "n" or $tariffe_consentite_vett_ut[$num2] == "SI") and !$dati_tariffe["tariffa$num2"]['importa_prezzi']) {
                                        ...
                                        } # fine if (!$tariffe_sel or ${"tariffa_sel".$num2})
                            ...
                            for ($num1 = 1; $num1 <= $numero_tariffe; $num1++) {
                                if (($attiva_tariffe_consentite_ut == "n" or $tariffe_consentite_vett_ut[$num1] == "SI") and !$dati_tariffe["tariffa$num1"]['importa_prezzi']) {
...
<input type=\"hidden\" name=\"tariffe_sel\" value=\"$tariffe_sel\">";
                        ...
                        } # fine if ($ins_form_tabella == "SI" and $priv_mod_tariffe != "n")
...
<input type=\"hidden\" name=\"tariffe_sel\" value=\"SI\">";
                        ...
                        echo "<br><table class=\"t1\" style=\"background-color: $t1color; margin-left: auto; margin-right: auto;\" border=\"$t1border\" cellspacing=\"$t1cellspacing\" cellpadding=\"$t1cellpadding\">";
...
#$nometariffa = str_replace(" ","&nbsp;",$nometariffa);
                                    ...
                                    if ($dati_tariffe[$tariffa]['importa_prezzi']) $nometariffa_vedi .= "<br><small><small style=\"white-space: nowrap;\">" . mex("prezzi importati", $pag) . "<br> " . mex("dalla tariffa", $pag) . " <b>" . $dati_tariffe[$tariffa]['importa_prezzi'] . "</b></small></small>";
                                    if ($dati_tariffe[$tariffa]['moltiplica'] == "p") $nometariffa_vedi .= "<br><small><small style=\"white-space: nowrap;\">(" . mex("per persona", $pag) . ")</small></small>";
...
<button class=\"smallsbutton selm\" type=\"submit\"><div>" . mex("Mostra solo tariffe selezionate", $pag) . "</div></button>
</td>";
                            for ($numtariffa = 1; $numtariffa <= $dati_tariffe['num']; $numtariffa++) {
                                if ($priv_vedi_tab_periodi != "p" or $attiva_tariffe_consentite == "n" or $tariffe_consentite_vett[$numtariffa] == "SI") {
                                    echo "<td><input type=\"checkbox\" name=\"tariffa_sel$numtariffa\" value=\"SI\" style=\"width: 14px; height: 12px;\"></td>";
                        ...
                        for ($num1 = 0; $num1 < $num_periodi; $num1++) {
                            ...
                            $sett_in_per = 0;
                            $tar_chiusa = array();
                            for ($numtariffa = 1; $numtariffa <= $dati_tariffe['num']; $numtariffa++) if ($dati_tariffe['tariffa' . $numtariffa]['chiusa'][$idperiodi]) $tar_chiusa[$numtariffa] = " style=\"background-color: #777777;\"";
                            ...
                            while ($sett_in_per == 0 or ($datafine <= $datafine_periodi and !$date_menu[$datafine])) {
                                ...
                                for ($numtariffa = 1; $numtariffa <= $dati_tariffe['num']; $numtariffa++) {
                                    $tariffa = "tariffa" . $numtariffa;
                                    if ($sett_in_per > 1 and $dati_tariffe[$tariffa]['chiusa'][$idperiodi]) $tar_chiusa[$numtariffa] = " style=\"background-color: #777777;\"";
                                ...
                                for ($numtariffa = 1; $numtariffa <= $dati_tariffe['num']; $numtariffa++) {
                                    ...
                                    if (!strcmp($$tariffa, "") and !strcmp($$tariffap, "")) $$tariffa = "&nbsp;";
                                        ...
                                        if ($dati_r2['napp']["tariffa" . $numtariffa] > 1) {
                                            ...
                                            if (strcmp($$tariffap, "")) $tar_app[$numtariffa] .= punti_in_num($$tariffap * $dati_r2['napp']["tariffa" . $numtariffa]) . "*p";
                            ...
                            for ($numtariffa = 1; $numtariffa <= $dati_tariffe['num']; $numtariffa = $numtariffa + 1) {
                                if ($priv_vedi_tab_periodi != "p" or $attiva_tariffe_consentite == "n" or $tariffe_consentite_vett[$numtariffa] == "SI") {
                                    if (!$tariffe_sel or ${"tariffa_sel" . $numtariffa}) {
                                        $tariffa = ${"tariffa" . $numtariffa};
                                        $tariffap = ${"tariffa" . $numtariffa . "p"};
                                        if ($dati_r2['napp']["tariffa" . $numtariffa] > 1) $p_app = "*" . $dati_r2['napp']["tariffa" . $numtariffa];
                                        else $p_app = "";
                                        $cella_prezzi = "<td" . $tar_chiusa[$numtariffa] . ">$tariffa$p_app";
                                        if (strcmp($tariffap, "")) {
                                            if (strcmp($tariffa, "")) $cella_prezzi .= " + ";
                                            $cella_prezzi .= $tariffap . "*$p_pers$p_app";
                                        ...
                                        if (!$form_tabella or ($attiva_tariffe_consentite_ut != "n" and $tariffe_consentite_vett_ut[$numtariffa] != "SI") or $dati_tariffe["tariffa$numtariffa"]['importa_prezzi']) $riga_prezzi_r .= $cella_prezzi;
                                        else {
                                            $riga_prezzi_r .= "<td" . $tar_chiusa[$numtariffa] . "><input type=\"text\" name=\"pertar$numtariffa\" value=\"$tariffa\" size=\"8\">$p_app";
                                            if ($dati_tariffe['tariffa' . $numtariffa]['moltiplica'] == "p") $riga_prezzi_r .= " + <input type=\"text\" name=\"pertar$numtariffa" . "p\" value=\"$tariffap\" size=\"6\">*$p_pers$p_app";
                                            $riga_prezzi_r .= "</td>";
                            ...
                            if ($riga_prezzi_prec != $riga_prezzi or $mos_tutti_per == "SI" or $sett_in_per_prec != $sett_in_per) {
                                if ($riga_prezzi_prec) {
                                    ...
                                    if ($sett_in_per_prec > 1) $idperiodi_vedi .= "<a href=\"./$pag?anno=$anno&amp;id_sessione=$id_sessione&amp;tipo_tabella=periodi&amp;mos_per_sing=SI&amp;form_tabella=$form_tabella&amp;$lista_tariffe_sel\" STYLE=\"TEXT-DECORATION: NONE\" title=\"" . mex("mostra prezzi $parola_settimanali", $pag) . "\"><b style=\"font-weight: normal; color: #666666;\">&prime;</b></a><br>
...
<td>$datafine_f_prec</td>";
                                    ...
                                    else echo $riga_prezzi_prec_r;
                                    echo "</tr>";
                                    $n_righe++;
                                    if ($form_tabella and $n_righe == 25) {
                                        echo $riga_tariffe_tab;
                                        $n_righe = 0;
                                    } # fine if ($form_tabella and $n_righe == 25)
...
<td>$datainizio_f_ini</td>
<td>$datafine_f_prec</td>
" . str_replace("name=\"pertar", "name=\"per$idperiodi_ini" . "tar", $riga_prezzi_prec_r) . "
</tr>";
                        echo "</table>";


                        if (!$form_tabella and !$tariffe_sel) echo "</div></form>";
...
<input type=\"hidden\" name=\"tariffe_sel\" value=\"$tariffe_sel\">";
                                ...
                                echo "<button class=\"edit\" type=\"submit\"><div>" . mex("Modifica i campi della tabella", $pag) . "</div></button>
</div></form><br>";
                                if ($id_utente == 1) {
                                    $data_fine_periodi = esegui_query("select max(idperiodi) from $tableperiodi");
                                    $data_fine_periodi = risul_query($data_fine_periodi, 0, 0);
...
<small>(<label><input type=\"checkbox\" name=\"importa_prezzi\" value=\"SI\" style=\"width: 14px; height: 12px;\" checked>" . mex("prova ad importare i prezzi", $pag) . "</label>";
                                        if ($tipo_periodi == "g") {
                                            echo ":<label><input type=\"radio\" name=\"tipo_importa\" value=\"giorn\" style=\"width: 14px; height: 12px;\" checked>" . mex("giornalmente", $pag) . "</label>
...
$frase_costi_agg
<br><table class=\"t1\" style=\"background-color: $t1color; margin-left: auto; margin-right: auto;\" width=3 border=\"$t1border\" cellspacing=\"$t1cellspacing\" cellpadding=\"$t1cellpadding\">
                        ...
                        for ($numtariffa = 1; $numtariffa <= $dati_tariffe['num']; $numtariffa = $numtariffa + 1) {
                            if ($priv_vedi_tab_periodi != "p" or $attiva_tariffe_consentite == "n" or $tariffe_consentite_vett[$numtariffa] == "SI") {
                                ...
                                if (@is_array($dati_tariffe[$tariffa]['commissioni_percent'])) {
                                    ...
                                    while (list($per_comm, $val_comm) = each($dati_tariffe[$tariffa]['commissioni_percent'])) {
                                        if ($per_comm != "def") {
        ...
        if ($tipo_tabella == "clienti" and $vedi_clienti != "NO") {
            ...
            if ($vedi_clienti == "PROPRI" or $vedi_clienti == "GRUPPI") {
                ...
                if ($vedi_clienti == "GRUPPI") {
                    while (list($idut_gr, $val) = each($utenti_gruppi)) if ($idut_gr != $id_utente) $condizione_utente .= " or utente_inserimento = '$idut_gr'";
            ...
            if ($cancella_clienti == "SI" or $cancella_cc_passate == "SI") {
                if ($modifica_clienti == "PROPRI" or $modifica_clienti == "GRUPPI") {
                    ...
                    if ($modifica_clienti == "GRUPPI") {
                        while (list($idut_gr, $val) = each($utenti_gruppi)) if ($idut_gr != $id_utente) $condizione_utente_canc .= " or utente_inserimento = '$idut_gr'";
                    ...
                    if (numlin_query($cert_cc)) {
                        ...
                        if (!$continua) {
                            for ($num1 = 0; $num1 < $num_cc; $num1++) {
                                $idclienti = risul_query($carte_di_credito, $num1, 'idclienti');
...
<h3 id=\"h_clie\"><span>" . mex("Tabella con tutti i clienti", $pag) . "$chiamati.</span></h3><br>";
                ...
                if ($cliente_fine > $num_clienti) {
                    $cliente_fine = $num_clienti;
                }
                ...
                echo "<table class=\"t1\" style=\"background-color: $t1color; margin-left: auto; margin-right: auto;\" width=3 border=\"$t1border\" cellspacing=\"$t1cellspacing\" cellpadding=\"$t1cellpadding\">
...
<td>";
                            if ($email) {
                                echo "<a style=\"color: #222222;\" href=\"mailto:$email\">$email_vedi</a>";
                            } else {
                                echo "&nbsp;";
                            }
                            echo "</td>";
...
<td>$motivazione</td>";
                ...
                echo "<br><br><h3 id=\"h_rul\"><span>" . mex("Tabella con le regole di assegnazione 2 del", $pag) . " $anno.</span></h3>
<br><table class=\"t1\" style=\"background-color: $t1color; margin-left: auto; margin-right: auto;\" width=3 border=\"$t1border\" cellspacing=\"$t1cellspacing\" cellpadding=\"$t1cellpadding\">
...
<td>" . mex("Appartamenti", 'unit.php') . "</td>";
                ...
                for ($num1 = 0; $num1 < $num_regole; $num1++) {
                    ...
                    if ($priv_vedi_tab_regole != "p" or $attiva_tariffe_consentite == "n" or $tariffe_consentite_vett[substr($tariffa, 7)] == "SI") {
                        ...
                        $html_tab[$lung] .= "<tr><td>" . $nometariffa_vedi[$tariffa] . "</td>
<td>$lista_app_spazi</td>";
                        if ($id_utente == 1 and $installazione_subordinata != "SI") $html_tab[$lung] .= "<td><a href=\"visualizza_tabelle.php?tipo_tabella=$tipo_tabella&amp;anno=$anno&amp;id_sessione=$id_sessione&amp;idregole=$idregole\">" . mex("cancella", $pag) . "</a></td>";
                        $html_tab[$lung] .= "</tr>";
                    } # fine if ($priv_vedi_tab_regole != "p" or $attiva_tariffe_consentite == "n" or...
                } # fine for $num1
                if ($html_tab) {
                    ksort($html_tab);
                    while (list($key, $val) = each($html_tab)) echo $val;
                } # fine if ($html_tab)
                echo "</table>";
...
<button class=\"irul\" type=\"submit\"><div>" . mex("Inserisci nuove regole", $pag) . "</div></button>
        ...
        if ($tipo_tabella == "appartamenti" and $priv_vedi_tab_appartamenti != "n") {
            ...
            if ($crea_app and $id_utente == 1 and C_CREA_NUOVI_APP != "NO") {
...
<hr style=\"width: 95%\">
            ...
            } # fine if ($crea_app and $id_utente == 1 and C_CREA_NUOVI_APP != "NO")
                ...
                if ($form_tabella) echo "<form accept-charset=\"utf-8\" method=\"post\" action=\"modifica_app.php\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
...
<input type=\"hidden\" name=\"form_tabella\" value=\"SI\">";
                ...
                echo "<table class=\"t1\" style=\"background-color: $t1color; margin-left: auto; margin-right: auto;\" width=3 border=\"$t1border\" cellspacing=\"$t1cellspacing\" cellpadding=\"$t1cellpadding\">
<tr><td>" . mex("Appartamento", 'unit.php') . "</td>
<td>" . mex("Casa", $pag) . "</td>
<td>" . mex("Piano", $pag) . "</td>
<td style=\"font-size: small;\">" . str_replace("_", "&nbsp;", mex("Capienza_massima", $pag)) . "</td>
...
<input type=\"text\" name=\"n_nome_app$num1\" value=\"$idappartamenti\" size=\"12\"></td>
...
<td>";
                            ...
                            echo "</td>
<td><input type=\"text\" name=\"n_priorita$num1\" value=\"$priorita\" size=\"8\"></td>";
                        } # fine else if (!$form_tabella)
                        ...
                        if ($modifica_app_vicini and $id_utente == 1) {
                            ...
                            for ($num1 = 0; $num1 < $num_appartamenti; $num1++) {
                                ...
                                if ((string)$app_vicini[$num1] != "") {
                                    ...
                                    sort($app_vic);
                                    reset($app_vic);
                                    while (list($key, $val) = each($app_vic)) $n_app_vicini .= "," . $val;
...
-->
                        ...
                        echo "<table class=\"m1\" style=\"background-color: $t1color; margin-left: auto; margin-right: auto; text-align: center; font-size: 75%;\" width=3 border=\"$t1border\" cellspacing=\"0\" cellpadding=\"1\"><tbody>";
...
" . mex("Importa l'invetario", $pag) . " <select name=\"app_a\">";
                        ...
                        if ($html_opt) {
                            ksort($html_opt);
                            while (list($key, $val) = each($html_opt)) echo $val;
                        } # fine if ($html_opt)
...
<td>" . ucfirst(mex("azione", $pag)) . "</td></tr>";
                            ...
                            if (@is_array($contratti_salvati)) {
                                ...
                                while (list($anno_doc, $val) = each($contratti_salvati)) {
                                    ...
                                    $tab_contr = "";
                                    while (list($n_contr_corr, $contr_corr) = each($contratti_salvati_anno)) {
                                        $num_doc_in_tab++;
...
<td>$lista_pren</td>";
                                    ...
                                    } # fine while (list($n_contr_corr,$contr_corr) = each($contratti_salvati_anno))
...
<button class=\"uplm\" type=\"submit\"><div>" . ucfirst(mex("fai l'upload", $pag)) . "</div></button>
                                ...
                                } # fine while (list($anno_doc,$val) = each($contratti_salvati))
...
<tr><td title=\"$titolo_int\" style=\"width: 20px; height: $altezza" . "px; background-color: " . $colore_col[$num2] . "; border: 1px solid #000000;";
            ...
            if ($option_tariffe_vett) {
                ...
                while (list($key, $val) = each($option_tariffe_vett)) $option_tariffe .= $val;
            ...
            if ($priv_vedi_tab_stat != "s") {
                ...
                if ($priv_vedi_tab_stat == "q" or $priv_vedi_tab_stat == "g") {
                    reset($utenti_gruppi);
                    while (list($idut_gr, $val) = each($utenti_gruppi)) if ($idut_gr != $id_utente) $condizione_prenota_proprie .= " or utente_inserimento = '$idut_gr'";
            ...
            for ($num1 = 0; $num1 < $num_anni; $num1++) {
                if (${"anno_sel" . $anni[$num1]}) {
                    ...
                    if (@is_array(${"num_origine" . $anno_stat})) {
                        ...
                        if (@is_array($num_origine)) {
                            reset($num_origine);
                            while (list($orig, $val) = each($num_origine)) {
                                if ($origini[$orig] != "SI") {
                                    $origini[$orig] = "SI";
                                    $x[$num_x] = $orig;
                            ...
                            } # fine while (list($orig,$val) = each($num_origine))
                        } # fine if (@is_array($num_origine))
            ...
            for ($num1 = 0; $num1 < $num_anni; $num1++) {
                if (${"anno_sel" . $anni[$num1]}) {
                    ...
                    if (@is_array(${"pagamenti" . $anno_stat})) {
                        ...
                        while (list($metodo, $val) = each($pagamenti_anno)) {
                        ...
                        } # fine while (list($metodo,$val) = each($pagamenti_anno))
            ...
            for ($num1 = 0; $num1 < $num_anni; $num1++) {
                if (${"anno_sel" . $anni[$num1]}) {
                    ...
                    if (@is_array(${"num_nazionalita" . $anno_stat})) {
                        ...
                        while (list($nazion, $val) = each($num_nazionalita)) {
                        ...
                        } # fine while (list($nazion,$val) = each($num_nazionalita))
