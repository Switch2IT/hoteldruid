...
<table class=\"m2\" style=\"margin-left: auto; margin-right: auto;\" border=2 cellspacing=0 cellpadding=1>";
            if ($mese2 != 1 and $tipo_periodi != "g") {
                $mese_inizio_tab = $mese2 - 1;
            } else {
            ...
            if ($mese2 != 25 and $tipo_periodi != "g") {
                $mese_fine_tab = $mese2 + 1;
            } else {
                $mese_fine_tab = $mese2;
            }
            ...
            if ($g_fine_tab >= 2) {
                $id_data_fine_tab = $id_data_fine_tab - $g_fine_tab + 1;
            }
