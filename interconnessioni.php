...
if ($id_utente and (($priv_crea_interconnessioni == "s" and $anno_utente_attivato == "SI") or $id_utente == $id_utente_azione_ic) and C_CREA_SUBORDINAZIONI != "NO") {
...
<div style=\"text-align: center;\"><input class=\"sbutton\" type=\"submit\" name=\"crea_subordinazione\" value=\"" . mex("Crea la subordinazione", $pag) . "\">
            ...
            while (list($mod_ext, $val_i) = each($interconnessioni)) {
                include("./includes/interconnect/$mod_ext/name.php");
                ...
                include("./includes/interconnect/$mod_ext/form.php");
            } # fine while (list($mod_ext,$val_i) = each($interconnessioni))
            closedir($interconn_dir);
...
} # fine if ($id_utente and (($priv_crea_interconnessioni == "s" and $anno_utente_attivato == "SI") or $id_utente == $id_utente_azione_ic) and C_CREA_SUBORDINAZIONI != "NO")
